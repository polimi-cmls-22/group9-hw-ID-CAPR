...
{
    knobImage = juce::ImageCache::getFromMemory(BinaryData::KnobCaprHW3_png, BinaryData::KnobCaprHW3_pngSize);
    
    /*knobImage2 = juce::ImageCache::getFromMemory(BinaryData::KnobCapr2_png, BinaryData::KnobCapr2_pngSize);
    knobImage = knobImage2;
